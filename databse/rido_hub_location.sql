...
CREATE TABLE `hub_location` (
  ...
  `hub_langitude` varchar(255) DEFAULT NULL,
  `hub_longitude` double NOT NULL,
  `hub_id` bigint DEFAULT NULL,
  `hub_latitude` double NOT NULL,
  PRIMARY KEY (`hub_location_id`),
  UNIQUE KEY `UK_mq25rl378mgkrphwgreddl2nv` (`hub_id`),
  CONSTRAINT `FKeg8uav7a0265sxfrt7nqstqiq` FOREIGN KEY (`hub_id`) REFERENCES `hub` (`hub_id`)
...
LOCK TABLES `hub_location` WRITE;
/*!40000 ALTER TABLE `hub_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `hub_location` ENABLE KEYS */;
UNLOCK TABLES;
