...
CREATE TABLE `find_item` (
  ...
  `date_of_ride` datetime(6) DEFAULT NULL,
...
--
-- Dumping data for table `find_item`
--

LOCK TABLES `find_item` WRITE;
/*!40000 ALTER TABLE `find_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `find_item` ENABLE KEYS */;
UNLOCK TABLES;
