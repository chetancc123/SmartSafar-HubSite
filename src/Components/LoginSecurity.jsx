...
const LoginSecurity = () => {
  ...
  const handleSaveChanges = () => {
    ...
    if (
      ...
      axios
        .post("http://localhost:8080/hub/change-byOldPassword/1", {
          oldPassword,
          newPassword,
          confirmPassword,
        })
    ...
    <>
      ...
      >
        <NavLink to={"/LoginSecurity"}>
          <Button bg={"#13C39C"}>Login & Security</Button>
        </NavLink>
      ...
      >
        ...
        >
          ...
          <Flex justifyContent="space-between" mt={10}>
            <Button bg="#13C39C" size="lg" onClick={handleSaveChanges}>
              Save Change
            </Button>
            <Button size="lg" mr={600}>
              Cancel
            </Button>
          </Flex>
        </Flex>
