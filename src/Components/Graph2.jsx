...
const Graph2 = () => {
  ...
  return (
    <Box p={4}>
      ...
      <Flex mb={4}>
        <Button
          colorScheme={graphType === "daily" ? "teal" : "gray"}
        ...
        <Button
          colorScheme={graphType === "weekly" ? "teal" : "gray"}
        ...
        <Button
          colorScheme={graphType === "monthly" ? "teal" : "gray"}
      ...
      {data.length > 0 && (
        <Box width="100%" height={300}>
          <ResponsiveContainer>
            <LineChart data={aggregateData(graphType)}>
