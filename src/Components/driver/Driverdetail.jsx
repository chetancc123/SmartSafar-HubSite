        ...
        >
          <Box>
            ...
            <Flex marginTop="2" justifyContent="center">
              <Text fontWeight="600" bg="#13C39C">Driver ID: {driverData.driverId}</Text>
            </Flex>
            <Flex marginTop="2">
              <Text fontWeight="700"> Total ride: </Text>
              <Text color="#13C39C" fontWeight="900" marginLeft="2">
              ...
              <Box>
                ...
                >
                  ...
                  <ModalContent>
                    ...
                    <ModalCloseButton />
                    <ModalBody>
                      <img src={documentData.dpassbook} alt="Document" />
                    </ModalBody>
                  </ModalContent>
                </Modal>
                ...
                >
                  ...
                  <ModalContent>
                    ...
                    <ModalCloseButton />
                    <ModalBody>
                      <img src={documentData.driverSignature} alt="Signature" />
                    </ModalBody>
                  </ModalContent>
                </Modal>
                ...
                <Box padding="2">
                  <Flex align="center">
                    ...
                    <Text marginLeft="4">{documentData.panNo || 'N/A'}</Text>
                  </Flex>
                </Box>
                ...
                <Box padding="2">
                  <Flex align="center">
                    ...
                    <Text marginLeft="4">{documentData.address || 'N/A'}</Text>
                  </Flex>
                </Box>
              </Box>
              <Box marginLeft="10">
