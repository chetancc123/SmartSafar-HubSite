...
import { Table, Thead, Tbody, Tr, Th, Td, Radio, RadioGroup, Input } from "@chakra-ui/react";
import { Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Flex, Box, Icon, Text } from "@chakra-ui/react";
    ...
    return (
       ...
       <Flex direction="row" h="100vh">
            <Flex direction="column" flex="1">
                ...
                <Box position="relative" w={{ base: "50%", md: "20%" }} h={{ base: "25px", md: "10px" }} p={4} bg="white" mb={{ base: 4, md: 0 }} mt={{ base: 10, md: "10px" }} ml={{ base: 0, md: "100px" }}>
                    <Text position="absolute" top="5px" left="50px" fontWeight="bold">Car At Charge</Text>
                   <NavLink to={"/Runningcar"}>
                   <Icon as={IoChevronBack} position="absolute" top="8px" left="5px" />
                   </NavLink>
                </Box>
                <Box w="900px" overflowY="auto" bg="white" borderRadius="10px" border="1px solid black" borderColor="blue.200" marginTop="10px" ml={{base:"none",md:"100px"}} overflowY="auto">
                    <Table variant="simple">
                        <Thead>
                            <Tr>
                                ...
                                <Th style={{ background: "#355eef", color: "black" }}>Approximate Charge Time</Th>
                                <Th style={{ background: "#355eef", color: "black" }}>Date and Time</Th>
                                <Th style={{ background: "#355eef", color: "black" }}>Change Request</Th>
                            </Tr>
                        </Thead>
                        <Tbody>
