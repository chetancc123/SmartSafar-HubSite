...
const Returncar = ({ children }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://localhost:8080/hub/get-all/carchange/${hubMangerId}/driverlist`
      )
      .then((response) => {
          ...
          <Box overflowY="auto">
            ...
            >
              <Table variant="simple">
                <Thead>
                  <Tr>
                    <Th style={{ background: "#13C39C", color: "black" }}>
                      S No.
                    </Th>
                    <Th style={{ background: "#13C39C", color: "black" }}>
                      Driver Name
                        ...
                        <RadioGroup value={car.carCondition}>
                          <Flex direction="row" gap="10px">
                            <Radio
                              value="WORST"
                              borderColor={
                                car.carCondition === "WORST" ? "red" : "red"
                              }
                              isDisabled={true}
                            ></Radio>
                            <Radio
                              value="NORMAL"
                              borderColor={
                                car.carCondition === "NORMAL" ? "blue" : "blue"
                              }
                              isDisabled={true}
                            ></Radio>
                            <Radio
                              value="GOOD"
                              borderColor={
                                car.carCondition === "GOOD" ? "green" : "green"
                              }
                              isDisabled={true}
                            ></Radio>
                          </Flex>
