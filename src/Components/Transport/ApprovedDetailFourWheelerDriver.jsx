...
const ApprovedDetailFourWheelerDriver = () => {
  ...
  const fetchDriverData = () => {
    axios
      .get(
        `http://localhost:8080/hub/getProfileApprovedForFour/${hubMangerId}/detailsById/${id}`
      )
      .then((response) => {
...
export default ApprovedDetailFourWheelerDriver;
