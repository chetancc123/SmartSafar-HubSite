...
const Approveddriverlisttransport = ({ children }) => {
    ...
    return (
      ...
      <Flex direction="row" h="100vh" mt={10} ml={20}>
                            ...
                            <Tr key={index}>
                                ...
                                <Td>
                                    <Button bg="#13C39C" size="md">
                                        <NavLink to={"/TransportApprovedDriverDetails"}>Details</NavLink>
                                    </Button>
                                </Td>
                                <Td>
                                    <Text
...
export default Approveddriverlisttransport;
