  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent>
        ...
        <ModalFooter>
          <Button colorScheme="#13C39C" mr={3} onClick={onClose}>
            Close
          </Button>
        </ModalFooter>
      </ModalContent>
...
const TransportDriverDetails = () => {
  ...
  return (
    <Box>
      <Box border="1px solid #13C39C" p="4" mb="4" mt={20} ml={10}>
        <Flex alignItems="center" justifyContent="space-between">
          ...
          <Flex alignItems="center" mt="10">
            <Box border="1px solid #13C39C" px="4" py="2" mb="2" mr="2">
              <Text fontWeight="bold" fontSize="md">
                Today Total Ride
              </Text>
              <Text fontWeight="bold" fontSize="md" color="#13C39C">
                2
              </Text>
            </Box>
            <Box border="1px solid #13C39C" px="4" py="2" mb="2" mr="2">
      ...
      <Box ml={10}>
        ...
        <Box border="1px solid #13C39C" p="4" mb="4">
          <Flex alignItems="center" justifyContent="space-between">
            <Box>
              <Flex m="3">
      ...
      <Box>
        <Flex justifyContent="center">
          <Flex justifyContent="center">
            <Button colorScheme="#13C39C" onClick={handleApprove}>
              Approve
            </Button>
            <Button colorScheme="#13C39C" ml="2" onClick={handleDecline}>
              Decline
            </Button>
          </Flex>
        </Flex>
