...
const PendingDetailDriverFourWheeler = () => {
  ...
  const fetchDriverData = () => {
    axios
      .get(
        `http://localhost:8080/hub/getProfilePendingForFour/${hubMangerId}/detailsById/${id}`
      )
      .then((response) => {
...
export default PendingDetailDriverFourWheeler;
